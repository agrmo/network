...
public class Zufallsgraph {
    ...
    public static int[][] nehmePaareArray(int n, double p) {
	ArrayList<int[]> paareAL = Zufallsgraph.nehmePaare(n, p);
	int[][] paareA = new int[paareAL.size()][2];

	for (int i = 0; i < paareAL.size(); i++) {
	    paareA[i] = paareAL.get(i);
	}
